<!-- Edit Modal-->
<div class="modal fade" id="transactionShow{{ $transaksi->id }}" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
    aria-hidden="true">
        ...
        <div class="modal-content">
            <div class="modal-header">
                ...
                <div class="modal-body container">
                    ...
                    @foreach ($transaksi->detail_transactions as $detail)
                    <div class="row mb-1">
                    ...
                    <div class="row mt-3">
                        ...
                        <div class="col-3"><b>Rp. {{ number_format($transaksi->total_price, 0, ',', '.') }}</b></div>
                    </div>
                </div>
                <div class="modal-footer">
                    <div class="text-muted" style="text-align: left; position: absolute; left: 1em;">
                        Created at : {{ $transaksi->created_at }}  <br>By : {{ $transaksi->user->name }}
                    </div>
